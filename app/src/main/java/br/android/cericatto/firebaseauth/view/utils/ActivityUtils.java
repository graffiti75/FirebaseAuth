...
public class ActivityUtils {
    ...
    public static void startActivityTransition(Activity activity, Class clazz, int viewId,
        int transitionNameId) {
    ...
    public static void startActivityForResultExtras(Activity activity, Class clazz, String[] keys,
        Object[] values, Integer intentReturn) {
        Intent intent = new Intent(activity, clazz);
    ...
    public static void startActivityForResultExtras(Activity activity, Class clazz, String key,
        Object value, Integer intentReturn) {
        Intent intent = new Intent(activity, clazz);
        Bundle extras = getExtra(new Bundle(), key, value);
        intent.putExtras(extras);
